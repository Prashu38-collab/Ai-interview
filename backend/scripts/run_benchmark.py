...
EXPECTATIONS: dict[str, dict] = {
    "correct": {"statuses": {"strong"}, "min": 7.0},
    "concise_correct": {"statuses": {"strong"}, "min": 7.0},
    "alternative_valid": {"statuses": {"strong"}, "min": 7.0},
    "partial": {"statuses": {"partial"}, "min": 2.0, "max": 7.0},
    "incorrect": {"statuses": {"incorrect"}, "max": 4.5},
    "irrelevant": {"statuses": {"irrelevant"}, "max": 2.5},
    "keyword_stuffing": {"statuses": {"keyword_stuffing"}, "max": 1.5},
    ...
    "question_repetition": {"statuses": {"question_repetition"}, "max": 1.5},
    "scenario": {"statuses": {"strong"}, "min": 7.0},
    "debugging": {"statuses": {"strong"}, "min": 7.0},
    "coding": {"statuses": {"strong"}, "min": 7.0},
    "system_design": {"statuses": {"strong"}, "min": 7.0},
    # Answer-validation acceptance cases (the pasted-question bug family).
    "accept_repeat": {"statuses": {"question_repetition"}, "max": 1.0},
    "accept_paraphrase": {"statuses": {"question_repetition"}, "max": 1.0},
    "accept_stuffing": {"statuses": {"keyword_stuffing"}, "max": 1.0},
    "accept_fragment": {"statuses": {"insufficient_evidence"}, "max": 2.0},
    "accept_short_strong": {"statuses": {"strong"}, "min": 7.0},
    "accept_irrelevant": {"statuses": {"irrelevant"}, "max": 2.0},
    "accept_wrong": {"statuses": {"incorrect"}, "max": 4.5},
    "accept_synonym": {"statuses": {"strong"}, "min": 7.0},
    "accept_partial": {"statuses": {"partial"}, "min": 2.0, "max": 7.0},
    "accept_qtype": {"statuses": {"incomplete"}, "max": 6.0},
}
